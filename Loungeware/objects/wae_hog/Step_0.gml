...
wae_hog_myrider.x = x
wae_hog_myrider.y = y
wae_hog_myrider.image_index = wae_hog_myrider.image_number -2
...
//misc
wae_hog_speed = min(3,max(0.5, wae_hog_speed))
